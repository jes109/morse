...
const char ssid[] = "Letmeconnect";
const char password[] = "morse11111";
...
void dot () {digitalWrite(BUZZ,HIGH); tone(BUZZ, 500); delay (100); digitalWrite(BUZZ,LOW); noTone(BUZZ); delay (200);}//改
void dash () {digitalWrite(BUZZ,HIGH); tone(BUZZ, 500); delay (300); digitalWrite(BUZZ,LOW); noTone(BUZZ); delay (200);}//改
